...
public class SlideDeck {
   ...
   * If the current slide is the last slide in the deck returns current slide again.
   */
   ...
   * If the current slide is the first slide in the deck returns the current slide again.
   */
